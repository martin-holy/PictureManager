namespace PictureManager {
  public enum BgBrushes { Default = 0, Marked = 1, Chosen = 2 }
  ...
  public enum Categories { FavoriteFolders = 0, Folders = 1, Ratings = 2, People = 3, FolderKeywords = 4, Keywords = 5, Filters = 6, Viewers = 7, GeoNames = 8 }
}