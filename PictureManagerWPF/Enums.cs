namespace PictureManager {
  ...
  public enum Category { FavoriteFolders = 0, Folders = 1, Ratings = 2, People = 3, FolderKeywords = 4, Keywords = 5, Filters = 6, Viewers = 7, GeoNames = 8, SqlQueries = 9 }
  ...
  public enum IconName { Folder, FolderStar, FolderLock, FolderOpen, Star, People, PeopleMultiple, Tag, TagLabel, Filter, Eye, DatabaseSql, Bug, LocationCheckin, Notification, Cd, Drive, DriveError, Cancel, Save }
}