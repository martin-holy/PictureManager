namespace PictureManager {
  ...
  public enum AppProperty { AppCore, WMain, SubmitChanges, FileOperationResult, EditKeywordsFromFolders }
  ...
  public enum IconName { Folder, FolderStar, FolderLock, FolderOpen, Star, People, PeopleMultiple, Tag, TagLabel, Filter, Eye, DatabaseSql, Bug, LocationCheckin, Notification, Cd, Drive, DriveError, Edit, Cancel, Save, Ruler, Settings }
}