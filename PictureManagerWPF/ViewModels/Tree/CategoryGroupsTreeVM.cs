...
namespace PictureManager.ViewModels.Tree {
  public sealed class CategoryGroupsTreeVM {
    ...
    public void SyncCollection(ObservableCollection<object> src, ObservableCollection<ICatTreeViewItem> dest, ICatTreeViewItem parent, DU.Tree.OnItemsChangedCat onItemsChanged) {
