...
namespace PictureManager.Domain.Utils {
  public static class Imaging {
    ...
    public delegate byte[] GetHashPixelsFunc(string filePath, int bytes);
    public delegate void ResizeJpgAction(string src, string dest, int px, bool withMetadata, bool withThumbnail, int quality);
    
    public static GetHashPixelsFunc GetHashPixels { get; set; }
    ...
    public static long GetAvgHash(string filePath) {
      // copy pixels
      var pixels = GetHashPixels(filePath, 8);
    ...
    public static long GetPerceptualHash(string filePath) {
      // copy pixels
      var pixels = GetHashPixels(filePath, 32);
